...
public class ContributorTest {
	...
	public void contributorShouldBeAbleTo_SubmitAPostForAdminReview_Test() {
		...
		given()
			...
			.auth().preemptive().basic("fener", "admin")
	...
	@Test
	public void contributorShouldNotBeAbleTo_PublishAPost_Test() {
	...
	given()
		.relaxedHTTPSValidation()
		.auth().preemptive().basic("bayram1001", "Arpali69@@.")
		.contentType(ContentType.JSON)
		.body("{\"status\":\"publish\"}" )
		.pathParam("idOfPendingPost", 12).
	when()
